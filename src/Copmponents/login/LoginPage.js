...
const LoginPage = () => {
  ...
  return (
    ...
    <div className="container main-signup-wraper d-flex flex-column flex-md-row align-items-center my-5 justify-content-center ">

      <Card className=" my-3 boxlogin flex-grow-1 mb-5 col-sm-12 col-md-6 mx-5"  style={{ width: "100%", maxWidth: "500px"}}>
        <Card.Body>
    ...
    {/* </div> */}
   <div className="my-5 col-sm-12 col-md-6" style={{ width: "100%", maxWidth: "500px" }}>
