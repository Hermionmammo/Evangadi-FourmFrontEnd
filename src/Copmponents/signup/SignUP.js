...
function SignUP() {
  ...
  return (
    <div className="container main-signup-wraper d-flex flex-column flex-md-row justify-content-center align-items-center">
      <Card
        className="boxlogin my-3 pt-4 col-sm-12 col-md-6"
      ...
      >
        <Card.Body>
          ...
          <form className="text-center form" onSubmit={handleSubmit}>
            ...
            <br />
            <Button className="mt-3 in1" type="submit">
              Agree and Join
            </Button>
            <div className=" text-center  loginlink">
      ...
      <div
        className="my-5 col-sm-12 col-md-6  px-md-5 px-sm-0"
        style={{ width: "100%", maxWidth: "500px" }}
      >
